...
for epoch in range(num_epochs):
    ...
    pd.DataFrame({'seed':[seed],'epoch':[epoch],'lr':[adam_learning_rate],'bs':[active_batch_size],
             'ap':[ap], 'auroc':[auroc], 'acc':[acc['accuracy']]}).to_csv('result_distilbert_pol/agg.csv',mode='a+')
...
fname = f"result_distilbert_pol/experiment_{seed}_batch_{active_batch_size}_lr_{adam_learning_rate}.parquet"
